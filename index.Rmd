...
Here are **all of the Aberdeen Priority Neighbourhoods with their total disadvantage score**.
...
-   Which people need more emergency medical care?

-   Which areas have high death rates?
...
**Red areas have higher emergency medical care than 95% of Scotland.**
...
aberdeen_priority %>%
  ...
  tab_header(
    title = "Priority Neighbourhoods", 
    subtitle = "ordered by most emergency medical care") %>%
  cols_label(
    data_zone = "Data Zone",
    dz_name = "Name", 
    total_population = "Population", 
    emerg = "emergency care (Scottish average = 100)")  %>%
  tab_options(container.height = 400,
              data_row.padding = 1,
              heading.padding = 1,
              column_labels.padding = 1)
...
**Red areas have higher death rates than 95% of Scotland.**

```{r}
#mortality
aberdeen_priority_sf %>%
  filter(smr_rank_scot <= 5) %>%
  mapview(
    map.types = "OpenStreetMap",
    zcol = "name",
    legend = FALSE,
...
aberdeen_priority %>%
  select(data_zone, dz_name, total_population, smr) %>%
  arrange(desc(smr)) %>%
  gt() %>%
  tab_header(
    title = "Priority Neighbourhoods", 
    subtitle = "ordered by highest death rates") %>%
  cols_label(
    data_zone = "Data Zone",
    dz_name = "Name", 
    total_population = "Population", 
    smr = "death rates (Scottish average = 100)")  %>%
  tab_options(container.height = 400,
              data_row.padding = 1,
              heading.padding = 1,
              column_labels.padding = 1)
